...
<form id="shorty">
  <fieldset class="personalblock">
    ...
    <input id="backend-static-base" type="text" name="backend-static-base"
           ...
           maxlength="256" placeholder="<?php echo $l->t('Specify a static base url…');?>" style="width:18em;">
    <br/>
    <label for="backend-example" class="aspect"> </label>
    <span id="backend-example">
      <label for="backend-static-example" class="aspect"><?php echo $l->t('Example:');?></label>
      <span id="backend-static-example" class="example" style="padding-left:0.5em;">
