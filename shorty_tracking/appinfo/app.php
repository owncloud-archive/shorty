...
\OC::$CLASSPATH['OCA\Shorty\Tracking\Loops']         = 'shorty_tracking/lib/loops.php';
...
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerClick',     'OCA\Shorty\Tracking\Hooks', 'registerClick');
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerDetails',   'OCA\Shorty\Tracking\Hooks', 'registerDetails');
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerActions',   'OCA\Shorty\Tracking\Hooks', 'registerActions');
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerIncludes',  'OCA\Shorty\Tracking\Hooks', 'registerIncludes');
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerQueries',   'OCA\Shorty\Tracking\Hooks', 'registerQueries');
//				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerHelp',      'OCA\Shorty\Tracking\Hooks', 'registerHelp');
				\OCP\Util::connectHook ( 'OCA\Shorty', 'registerDocuments', 'OCA\Shorty\Tracking\Loops', 'registerDocuments');
			}
