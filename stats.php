...
/**
 * @file stats.php
 * This is the plugins central statistic service
 * @access public
 * @author Christian Reiner
 */
...
// 		':id'     => $p_id,
	...
	switch ( $p_query ) {
		default: 
			throw new OC_Shorty_Exception ( "Request for undefined query '%1'.", array($p_query) );
		case 'overview':
			$query = OCP\DB::prepare ( OC_Shorty_Query::STATS_SHORTY_OVERVIEW );
			break;
	} // switch
	...
	OCP\Util::writeLog( 'shorty', sprintf("Delivered response to remote stats call", OC_Log::DEBUG ) );
