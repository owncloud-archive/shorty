...
class Loops
{
	 ...
	 * @author Christian Reiner
	 */
	public static function raiseShortyEventRequest($shorty, $request, $result)
	{
		...
		\OCP\Util::emitHook('\OCA\Shorty', 'raiseShortyEventRequest', array('shorty' => $shorty, 'request' => $request));
	} // function raiseShortyEventRequest
