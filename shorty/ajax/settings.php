	...
	switch ( $_SERVER['REQUEST_METHOD'] )
	{
		case 'POST':
			...
			foreach (array_keys($_POST) as $key) {
				...
				if ( isset(OC_Shorty_Type::$SETTING[$key]) )
				{
			...
			OCP\JSON::success ( array (
				'data'    => $data,
				'level'   => 'debug',
 				'message' => OC_Shorty_L10n::t("Set setting(s) '%s'",implode(',',array_keys($data)))
			) );
			break;
		...
		case 'GET':
			...
			OCP\JSON::success ( array (
				'data'    => $data,
				'level'   => 'debug',
				'message' => OC_Shorty_L10n::t("Get setting(s) '%s'",implode(',',array_keys($data)))
			) );
			break;
