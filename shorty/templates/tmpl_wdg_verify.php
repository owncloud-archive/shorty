...
<div id="shorty-dialog-verification" title="<?php p(OC_Shorty_L10n::t("Static backend: base url verification")); ?>">
	<!-- success -->
	<div class="success">
		<fieldset>
			<legend>
				...
				<span id="shorty-title" class="shorty-title"><strong><?php p(OC_Shorty_L10n::t("Verification successful")); ?>!</strong></span>
			</legend>
	...
	<div class="failure">
		<fieldset>
			<legend>
				...
				<span id="shorty-title" class="shorty-title"><strong><?php p(OC_Shorty_L10n::t("Verification failed")); ?>!</strong></span>
			</legend>
