...
<form id="dialog-share" class="shorty-dialog shorty-embedded shorty-hidden">
	<fieldset>
		<legend class="">
			...
			<span class="heading"><?php p(L10n::t("Share and use").':'); ?></span>
		</legend>
		...
		<span class="label-line">
			...
			<span id="blocked" class="status-hint" style="display:none;"><?php p(L10n::t("for any access")."."); ?></span>
			<span id="private" class="status-hint" style="display:none;"><?php p(L10n::t("for own usage")."."); ?></span>
			<span id="shared"  class="status-hint" style="display:none;"><?php p(L10n::t("with ownCloud users")."."); ?></span>
			<span id="public"  class="status-hint" style="display:none;"><?php p(L10n::t("available for everyone")."."); ?></span>
		</span>
		<div class="shorty-usages">
			<fieldset class="shorty-collapsible collapsed">
				<label for="source-text"><?php p(L10n::t("Source url").':'); ?></label>
				<span id="source-text"><?php p(L10n::t("This is the shortened url registered at the backend").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="source" class="shorty-clickable" target="_blank"
						title="<?php p(L10n::t("Open source url")); ?>"
						href=""></a>
				</div>
			</fieldset>
			<fieldset class="shorty-collapsible collapsed">
				<label for="relay-text"><?php p(L10n::t("Relay url").':'); ?></label>
				<span id="relay-text"><?php p(L10n::t("This is a internal url that the shortened url relays to").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="relay" class="shorty-clickable" target="_blank"
						title="<?php p(L10n::t("Open relay url")); ?>"
						href=""></a>
				</div>
			</fieldset>
			<fieldset class="shorty-collapsible collapsed">
				<label for="target-text"><?php p(L10n::t("Target url").':'); ?></label>
				<span id="target-text"><?php p(L10n::t("This is the target url specified when generating this Shorty").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="target" class="shorty-clickable" target="_blank"
						title="<?php p(L10n::t("Open target url")); ?>"
						href=""></a>
				</div>
			</fieldset>
		</div>
...
<?php if ('disabled'!=$_['sms-control']) { ?>
				<td>
					<img id="usage-sms" name="usage-sms" class="shorty-usage svg" alt="sms"
						...
						title="<?php p(L10n::t("Send by SMS")); ?>" />
				</td>
<?php } ?>
				<td>
					<img id="usage-clipboard" name="usage-clipboard" class="shorty-usage svg" alt="clipboard"
						...
						title="<?php p(L10n::t("Copy to clipboard")); ?>" />
				</td>
			</tr>
		</table>
	</fieldset>
