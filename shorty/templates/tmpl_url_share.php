	...
	<fieldset>
		...
		<div class="shorty-usages">
			<fieldset class="shorty-collapsible collapsed">
				...
				<span id="source-text"><?php p(OC_Shorty_L10n::t("This is the shortened url registered at the backend").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="source" class="shorty-clickable" target="_blank"
						title="<?php p(OC_Shorty_L10n::t("Open source url")); ?>"
						href=""></a>
				</div>
			</fieldset>
			<fieldset class="shorty-collapsible collapsed">
				<label for="relay-text"><?php p(OC_Shorty_L10n::t("Relay url").':'); ?></label>
				<span id="relay-text"><?php p(OC_Shorty_L10n::t("This is a internal url that the shortened url relays to").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="relay" class="shorty-clickable" target="_blank"
						title="<?php p(OC_Shorty_L10n::t("Open relay url")); ?>"
						href=""></a>
				</div>
			</fieldset>
			<fieldset class="shorty-collapsible collapsed">
				<label for="target-text"><?php p(OC_Shorty_L10n::t("Target url").':'); ?></label>
				<span id="target-text"><?php p(OC_Shorty_L10n::t("This is the target url specified when generating this Shorty").'.'); ?></span>
				<div class="shorty-collapsible-tail" style="display:none;">
					<a id="target" class="shorty-clickable" target="_blank"
						title="<?php p(OC_Shorty_L10n::t("Open target url")); ?>"
						href=""></a>
				</div>
			</fieldset>
		</div>
