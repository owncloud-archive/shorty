...
<form id="dialog-edit" class="shorty-dialog shorty-standalone shorty-hidden" autocomplete="off">
	<fieldset>
		<legend class="">
		...
		<span class="heading"><?php p(L10n::t('Modify shorty').':'); ?></span>
		</legend>
...
?>
		...
		<textarea id="notes" name="notes" maxlength="4096" data="" class=""
				placeholder="<?php p(L10n::t('Anything that appears helpful…')); ?>">
		</textarea>
		<br />
		<span class="label-line">
		...
		<button id="confirm" class="shorty-button-submit"><?php p(L10n::t('Save')); ?></button>
	</fieldset>
</form>
