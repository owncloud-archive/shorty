...
switch ( OCP\Config::getSystemValue('dbtype') )
{
	case 'pgsql':
		class OC_Shorty_Query
		{
			...
			const URL_INSERT	           = "INSERT INTO *PREFIX*shorty (id,status,title,favicon,source,target,\"user\",until,created,notes) VALUES (:id,:status,:favicon,:title,:source,:target,:user,:until,CURRENT_DATE,:notes)";
